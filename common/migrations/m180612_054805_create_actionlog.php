...
class m180612_054805_create_actionlog extends Migration
{
    ...
    public function safeUp()
    {
        ...
        $this->createTable('{{%action_log}}', [
            ...
            'user_ip'           => $this->string(15)->notNull()->comment('IP'),
            'action'            => $this->string(100)->notNull()->comment('方法'),
            'controller'        => $this->string(100)->notNull()->comment('控制器'),
            'module'            => $this->string(20)->notNull()->comment('操作模块'),
